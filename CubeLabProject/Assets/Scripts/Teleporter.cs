...
public class Teleporter : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            //캐릭터가 속한 플로어 바꾸기
            characterColl.GetComponentInParent<Character>().floor = otherTele.GetComponent<Teleporter>().attachedFloor;
            //캐릭터의 플로어 스크립트 변경
            characterColl.GetComponentInParent<Character>().fl = characterColl.GetComponentInParent<Character>().floor.GetComponent<Floor>();
            //캐릭터의 위치 변경
